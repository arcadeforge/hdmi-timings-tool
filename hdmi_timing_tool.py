...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        super_res = int(sys.argv[5])

        read_calibration_conf()

 
    else:
        print ("hdmi_timings_tool:\n")
        print ("Param 1 : x resolution\n")
        print ("Param 2 : y resolution\n")
        print ("Param 3 : frequency, ie 60\n")
        print ("Param 4 : rotation in degree 0, 90, 180, 270\n")
        print ("Param 5 : compute super resoltion with 0 or 1\n")
        quit()
